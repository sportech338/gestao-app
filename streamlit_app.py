...
if menu == "📦 Dashboard – Logística":
    ...
    colunas = ["fulfillment_status", order_col, "customer_name", "product_title", "variant_title", "quantity",
               "forma_entrega", "customer_email", "customer_phone", "customer_cpf", "endereco", "bairro", "cep", "estado", "cidade", "created_at"]
