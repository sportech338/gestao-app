...
if menu == "📦 Dashboard – Logística":
    ...
    st.caption("Gestão completa de pedidos, estoque e entregas via Shopify API.")
 ...
 # =====================================================
    ...
    with aba[0]:
        ...
        st.caption("Visualização dos pedidos, processamento manual e status de entrega.")
        ...
        tabela.rename(columns={
            ...
            "product_title": "Produto", "variant_title": "Variante", "fulfillment_status": "Status de processamento",
            "forma_entrega": "Frete", "estado": "Estado"
        }, inplace=True)

        tabela["duplicado"] = tabela.duplicated(subset=["CPF", "E-mail", "Telefone", "Endereço"], keep=False)
